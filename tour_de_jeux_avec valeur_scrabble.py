from pioche_renvoie_scrabble import piocher, init_dico, init_pioche, echanger, completer_main
...
def tour_joueur(board, main, sac, joueurs, ordre, liste_mots, premiertour):
    ...
    #PLACE DES JETONS - TESTER LES FONCTION DU MODULES PLACEMENT
        ...
        def valeur_mot(mot,dico,scrabble):
            valeur=0
            for c in mot.upper():
...
init_bonus(board)
#sac = ['R','O','B','I','N','E','T']
tour_joueur(board, joueurs[ordre]["main"], sac, joueurs, ordre,liste_mots, premiertour=False)
